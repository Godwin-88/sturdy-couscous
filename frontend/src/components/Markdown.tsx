  ...
  return (
    <div className="markdown-body text-left text-xs leading-relaxed break-words">
      <ReactMarkdown
        ...
        components={{
          a: ({ node: _node, ...props }) => (
            <a {...props} target="_blank" rel="noreferrer" className="text-brand-400 underline" />
          ),
          ...
          h1: ({ children }) => <h1 className="text-sm font-bold text-brand-300 mt-2 mb-1 break-words">{children}</h1>,
          h2: ({ children }) => <h2 className="text-[13px] font-bold text-brand-300 mt-2 mb-0.5 break-words">{children}</h2>,
          ...
          blockquote: ({ children }) => (
            <blockquote className="my-1.5 border-l-2 border-brand-500/60 pl-2 text-slate-300 italic break-words">
              {children}
            </blockquote>
          ),
