    ...
    <div className="rounded-xl border border-slate-700 bg-slate-900 overflow-hidden">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-slate-700 bg-slate-950">
        ...
        <button onClick={goAnalyzePortfolio}
          ...
          className="flex items-center gap-1 px-2 py-1 rounded bg-brand-600/30 border border-brand-500/40 text-[10px] font-bold text-brand-300 hover:bg-brand-600/50">
          Analyze Portfolio
        </button>
